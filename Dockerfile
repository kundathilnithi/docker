...
RUN wget  https://github.com/gruntwork-io/terragrunt/releases/download/v0.68.1/terragrunt_linux_amd64 -P /usr/local/bin/
RUN mv  /usr/local/bin/terragrunt_linux_amd64 /usr/local/bin/terragrunt
